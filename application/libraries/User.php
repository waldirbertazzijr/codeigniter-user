...
class User
{
    ...
    */
     ...
     *
     */
    public function on_invalid_session($destiny)
    {
     ...
     *
     */
    public function on_valid_session($destiny)
    {
        if (is_object($this->user_data) && $this->validate_session()) {
    ...
    */
    public function login($login, $password, $update_last_login = true, $hashed_password = false)
    {
     ...
     * @return boolean
     */
    public function match_password($password_string)
    {
    ...
    public function has_permission($permission_name)
    {
        if (! $this->CI->session->userdata('logged')) {
            return false;
        } elseif (in_array($permission_name, $this->user_permission)) {
            return true;
        } else {
            return false;
        }
     ...
     * @return boolean
     */
    public function update_login($new_login)
    {
        // updates the session
     ...
     * @return boolean
     */
    public function update_pw($new_pw)
    {
        // hashes the password
     ...
     * @return boolean
     */
    public function destroy_user($destiny)
    {
     ...
     * @author Waldir Bertazzi Junior
     **/
    public function set_custom_field($user_id, $name, $value)
    {
